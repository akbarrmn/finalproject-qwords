<div class="px-20 flex flex-col gap-10 pb-20 bg-primary">
    <div class="flex justify-center px-10">
        <div class="flex flex-col justify-center items-center gap-5">
            <h1 class="text-4xl font-bold text-white">Komitmen Qwords</h1>
            <div class="flex justify-center">
                <p class="text-base max-w-4xl text-center text-white">Berbagai alasan mengapa pelanggan memilih sewa hosting di
                    Qwords</p>
            </div>
        </div>
    </div>
    <swiper-container class="mySwiper" space-between="30" slides-per-view="3" navigation="true">
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">Layanan 24/7</h1>
                    <p class="text-base max-w-[230px]">Tim Technical Support dan Customer Service Qwords siap membantu
        ...
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">Panduan Manual Lengkap</h1>
                    <p class="text-base max-w-[230px]">
                        Qwords dilengkapi dengan halaman knowledge base berisi tutorial dan tips seputar pengelolaan
        ...
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">Up time 99.99%</h1>
                    <p class="text-base max-w-[230px]">
        ...
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">Jaminan keamanan</h1>
                    <p class="text-base max-w-[230px]">
        ...
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">Clustered DNS</h1>
                    <p class="text-base max-w-[230px]">
        ...
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">High Enterprise Server</h1>
                    <p class="text-base max-w-[230px]">
        ...
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">Tier 1 Network</h1>
                    <p class="text-base max-w-[230px]">
        ...
        <swiper-slide>
            <div class="relative w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl font-bold">Peering Network</h1>
                    <p class="text-base max-w-[230px]">
